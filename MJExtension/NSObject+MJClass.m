...
{
    return [self mj_totalIgnoredPropertyNames];
}

+ (void)setupAllowedCodingPropertyNames:(MJAllowedCodingPropertyNames)allowedCodingPropertyNames
{
    [self mj_setupAllowedCodingPropertyNames:allowedCodingPropertyNames];
}

+ (NSMutableArray *)totalAllowedCodingPropertyNames
{
     return [self mj_totalAllowedCodingPropertyNames];
}
...
{
    return [self mj_totalIgnoredCodingPropertyNames];
}

+ (void)setupBlockReturnValue:(id (^)())block key:(const char *)key
{
    [self mj_setupBlockReturnValue:block key:key];
}
@end
