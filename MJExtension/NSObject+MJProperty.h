...
+ (id)mj_getNewValueFromObject:(__MJWeakRef id)object oldValue:(__MJWeakRef id)oldValue property:(__MJWeakRef MJProperty *)property;
...
+ (id)getNewValueFromObject:(__MJWeakRef id)object oldValue:(__MJWeakRef id)oldValue property:(__MJWeakRef MJProperty *)property MJExtensionDeprecated("请在方法名前面加上mj_前缀，使用mj_***");
